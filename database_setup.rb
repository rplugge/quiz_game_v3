...
CONNECTION.execute("CREATE TABLE IF NOT EXISTS answers (id INTEGER PRIMARY KEY, answer_text TEXT NOT NULL, question_id INTEGER NOT NULL, FOREIGN KEY(question_id) REFERENCES questions(id));")
